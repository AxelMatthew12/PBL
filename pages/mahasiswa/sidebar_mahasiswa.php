...
<!--Catatan : -->
<!--margin-top: 70px adalah code untuk mengatur tinggi dari sidebar-->
<!--Sidebar -->
<div class="sidebar" style="background-color: #F4F2EC; color: #696161; width: 200px; display: flex; flex-direction: column; align-items: flex-start; padding: 0px; margin-top: 70px; position: fixed; top: 0; left: 0; height: 90%; z-index: 1000;">
    ...
    <div class="user-info" style="display: flex; align-items: center; padding: 10px; gap: 20px;">
        <img src="../../view/img/siswi1.jpeg" alt="Foto Dosen" style="width: 60px; height: 60px; margin-left: 0px; margin-top: 10px;">
    ...
    <div class="menu" style="width: 100%; margin-top: 5px;">
        ...
        <table>
            ...
            <tr>
                <td>
                    <a href="mahasiswa_dashboard.php?page=dashboard">Dashboard</a>
                </td>
            </tr>
            <tr>
                <td>
                    <a href="riwayat_pelanggaran.php?page=riwayat">Riwayat Pelanggaran</a>
                </td>
            </tr>
            <tr>
                <td>
...
<div style="margin-left: 190px; padding: 0px;">
