    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/PBL/app/view/login/">Login</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="col-md-6 mb-3 d-flex justify-content-center">
                <div class="card shadow-sm" style="width: 100%; max-width: 500px;">
                    <div class="card-body text-center">
                        ...
                        <a target="_blank" href="../public/img/home/tentangImage.png" class="d-block">
                            <img src="../public/img/home/tentangImage.png" alt="Flowchart Image" class="img-fluid rounded shadow" style="width:150px;">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-3 d-flex justify-content-center">
                <div class="card shadow-sm" style="width: 100%; max-width: 500px;">
                    <div class="card-body text-center">
                        ...
                        <a target="_blank" href="../public/img/home/tentangImage.png" class="d-block">
                            <img src="../public/img/home/tentangImage.png" alt="Mockup Image" class="img-fluid rounded shadow" style="width:150px;">
                        </a>
                    </div>
                </div>
            </div>
