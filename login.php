...
if ($session->get('is_login') === true) {
    ...
    if ($role === 'admin') {
        ...
        header('Location: pages/dosen/dosen_dashboard.php?page=dashboard'); // Arahkan ke halaman dashboard user
    } else if ($role === 'mahasiswa') {
        header('Location: pages/mahasiswa/mahasiswa_dashboard.php?page=dashboard'); // Arahkan ke halaman dashboard mahasiswa
    }
    exit;
}
